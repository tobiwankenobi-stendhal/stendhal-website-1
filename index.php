...
header("X-Content-Security-Policy-Report-Only: default-src 'self'; img-src 'self' data: stendhalgame.org arianne.sf.net arianne.sourceforge.net https://sflogo.sourceforge.net ;report-uri ".STENDHAL_LOGIN_TARGET."/?id=content/scripts/cspreport");
