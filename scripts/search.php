...
class Searcher {
	...
	function searchIndex() {
		...
		$sql = "SELECT stendhal_category_search.entitytype, page.page_title As entityname, (stendhal_category_search.searchscore + 2000) * "
				. count($terms)	. " As score, stendhal_category_search.category As category"
				. " FROM a1111_wiki.page, a1111_wiki.searchindex, a1111_wiki.categorylinks, a1111_wiki.stendhal_category_search"
