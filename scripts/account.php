...
function displayLogin(){
   if(checkLogin()){ 
     echo 'Logged in as <b>'.$_SESSION['username'].'</b>. <a href="/index.php?id=content/account/meeting">Meeting Registration</a> - <a href="/account/history.html">Login history</a> - <a href="/?id=login/changepassword">Change password</a> - <a href="/?id=login/logout">Logout</a>';
   }
   else{
