...
for ($i = 0; $i < count($lines); $i++) {
	...
	if (count($matches) >= 4) {
		...
		$line = preg_replace('!(http|https)://(faiumoni.de|stendhalgame.org|arianne.sf.net|arianne.sourceforge.net|sourceforge.net|sf.net|download.oracle.com)(/[^ ]*)?!', '<a href="$1://$2$3">$1://$2$3</a>', $line);
