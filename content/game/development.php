...
<ul id="dmenu" >  
	<li><a href="http://arianne.sourceforge.net/wiki/index.php?title=StendhalCodeDesign"><img src="images/buttons/c_code_button.png">Code</a> - details of code designs and conventions</li>
		  <li><a href="http://arianne.sourceforge.net/wiki/index.php?title=StendhalRPProposal"><img src="images/buttons/rpsystem_button.png">RP System</a> - proposed new system which is in planning stages</li>
        	          <li><a href="http://arianne.sourceforge.net/wiki/index.php?title=StendhalRefactoringGraphics"><img src="images/buttons/c_gfx_button.png">Graphics</a> - artists, this one is for you</li>
   ...
   <li><a href="http://arianne.sourceforge.net/wiki/index.php?title=StendhalRefactoringQuests"><img src="images/buttons/quests_button.png">Quests</a> - planned or ideas</li>
...
If you plan to help with Stendhal development it is a very good idea to talk about it with the developers and contributors at the <a href="?id=content/game/chat">irc channel #arianne</a>.  
<?php endBox(); ?>
