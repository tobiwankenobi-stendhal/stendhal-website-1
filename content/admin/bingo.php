...
class BingoPage extends Page {
	...
	public function __construct() {
		$this->query = "SELECT id, killed, killer, killer_type FROM kills WHERE id<'".mysql_real_escape_string($_REQUEST['lastid'])."' AND killed_type='C' ORDER BY id DESC LIMIT 1";
