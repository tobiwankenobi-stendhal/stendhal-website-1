...
<?php
	...
	if (isset($name)) {
		startBox('<h1>History for player '. htmlspecialchars($name).'</h1>');

		echo '<p>History for player <a href="/?id=content/scripts/character&amp;name='.surlencode($name).'">'.htmlspecialchars($name).'</a>.</p>';
