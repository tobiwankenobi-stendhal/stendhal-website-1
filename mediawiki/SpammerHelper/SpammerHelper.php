...
require_once( "$IP/extensions/spammerHelper/SpammerHelper.php" );
EOT;
        exit( 1 );
}
...
$wgExtensionCredits['specialpage'][] = array(
        ...
        'name' => 'Spammer Helper',
        'author' => 'madmetzger',
        'url' => 'https://www.mediawiki.org/wiki/Extension:SpammerHelper',
...
$wgSpecialPages['SpammerHelper'] = 'SpecialSpammerHelper'; # Tell MediaWiki about the new special page and its class name
$wgSpecialPageGroups['SpammerHelper'] = 'other';
