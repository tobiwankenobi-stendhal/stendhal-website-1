...
class LightOpenID
{
     ...
     *
     * In order to use the openid+oauth hybrid protocol, you need to add at least one scrope
     * to the $openid->oauth[] array before you get the call to getAuthUrl(). Furthermore
     * the registered consumer name must fit the openid realm. To register an openid consumer
     * at Google use https://www.google.com/accounts/ManageDomains
     * 
