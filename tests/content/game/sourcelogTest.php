...
class SourceLogPageTest extends PHPUnit_Framework_TestCase {
	...
	public function testFormatLine() {
		...
		$exspected = '<span class="sourcetime">2011-02 16:15</span> <span class="sourceuser">nhnb</span>  <a class="sourcerev" href="http://arianne.git.sourceforge.net/git/gitweb.cgi?p=arianne/marauroa.git;a=commitdiff;h=55da9e45f6ca">55da9e45f6ca</a> <span class="sourcemodule">marauroa</span> <span class="sourcefiles">.gitignore</span>:<br><span class="sourcecommit"> added build to .gitignore';
		$this->assertEquals($exspected, $page->formatLine('2011', '02', $line));
		...
		$exspected = '<span class="sourcetime">2011-02 23:12</span> <span class="sourceuser">nhnb</span> <span class="sourcedevbranch">&nbsp;perception_delta_container&nbsp;</span> <a class="sourcerev" href="http://arianne.git.sourceforge.net/git/gitweb.cgi?p=arianne/marauroa.git;a=commitdiff;h=7f9fdd2cc388">7f9fdd2cc388</a> <span class="sourcemodule">marauroa</span> <span class="sourcefiles">src/marauroa/ (2 files in 2 dirs)</span>:<br><span class="sourcecommit"> converted ChangeContainer into an abstract singleton class and wrote a logging implementation';
		$this->assertEquals($exspected, $page->formatLine('2011', '02', $line));
	}
}
